...
public class Initialize {
    ...
    public static int REQUEST_CODE_HOME;
    public static int RESULT_CODE_HOME;
    public static int REQUEST_CODE_COMPANY;
    public static int RESULT_CODE_COMPANY;
    public static int REQUEST_CODE_OTHERPLACE;
    public static int RESULT_CODE_OTHERPLACE;
    ...
    public static void init(Context context){
        ...
        REQUEST_CODE_HOME = 5;
        RESULT_CODE_HOME = 55;
        REQUEST_CODE_COMPANY = 6;
        RESULT_CODE_COMPANY = 66;
        REQUEST_CODE_OTHERPLACE = 7;
        RESULT_CODE_OTHERPLACE = 77;
